        ...
        <div class="forGetBox LoginFast">
          <div class = 'bottom'>
               <el-form :model="ruleForm"  :rules="rules" ref="ruleForm"  class="demo-ruleForm">
                ...
                <div>
                   <div class="ln">
                     <div id="loginfastDetailBlock0001"></div>
                   </div>
                   <input type='hidden' id='csessionid0001' name='csessionid0001'/>
                   <input type='hidden' id='sig0001' name='sig0001'/>
                   <input type='hidden' id='token0001' name='token0001'/>
                   <input type='hidden' id='scene0001' name='scene0001'/>
                </div>
                <!-- 滑块验证结束 -->
<!--                 滑块验证开始
<div>
   <div class="ln">
     <div id="detailloginfastBlock"></div>
   </div>
   <input type='hidden' id='csessionid001' name='csessionid001'/>
   <input type='hidden' id='sig001' name='sig001'/>
   <input type='hidden' id='token001' name='token001'/>
   <input type='hidden' id='scene001' name='scene001'/>
</div>
滑块验证结束 -->
...
export default {
  ...
  methods: {
   ...
   handleSlide(session, sig, nc_token, nc_scene){
     console.log('11')
      this.handleSlides(session, sig, nc_token, nc_scene)
    },
    send(form) {
      this.sendMsg = false;
      const me = this;   
      ...
      console.log('me',me.handleSlide)
      Lib.M.sendMessage(form,me,send_list,'#loginfastDetailBlock0001','csessionid0001','sig0001','token0001','scene0001');
    },
    focus(form){
