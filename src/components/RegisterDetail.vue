    ...
    <el-dialog
        ...
        <div class="forGetBox">
         <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm registerForm">
          ...
          <div>
                  <div class="ln">
                    <div id="registerDetailBlock"></div>
                  </div>
                  <input type='hidden' id='csessionid0003' name='csessionid0003'/>
                  <input type='hidden' id='sig0003' name='sig0003'/>
                  <input type='hidden' id='token0003' name='token0003'/>
                  <input type='hidden' id='scene0003' name='scene0003'/>
          </div> 
          <!-- 滑块验证结束 -->
...
/*                                                          if(data.loginBonusStatus != 1){
      ...
      const send_list  = Lib.M.noSignRequest(
        ...
        Lib.M.sendMessage(form,that,send_list,'#registerDetailBlock','csessionid0003','sig0003','token0003','scene0003')
      }
  }
}
</script>
