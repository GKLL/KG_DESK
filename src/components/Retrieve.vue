       ...
       :lock-scroll = "false"
        ...
        <div class="forGetBox">
          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm">  
                ...
                <div>
                  <div class="ln">
                    <div id="retrieveBlock"></div>
                  </div>
                  <input type='hidden' id='csessionid2' name='csessionid2'/>
                  <input type='hidden' id='sig2' name='sig2'/>
                  <input type='hidden' id='token2' name='token2'/>
                  <input type='hidden' id='scene2' name='scene2'/>
                </div>
                <!-- 滑动验证结束 -->
...
export default {
  ...
  methods: {
    ...
    const send_list  = Lib.M.noSignRequest(
        ...
        Lib.M.sendMessage(form,this,send_list,'#retrieveBlock','csessionid2','sig2','token2','scene2')
    }
  }
}
</script>
