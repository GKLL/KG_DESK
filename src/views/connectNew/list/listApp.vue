<template>
  ...
  <el-form :model="ruleForm"  :rules="rules" ref="ruleForm"  class="demo-ruleForm loginForm">
          ...
          <!-- 滑块验证开始 -->
                <div>
                   <div class="ln">
                     <div id="connectNewBlock"></div>
                   </div>
                   <input type='hidden' id='csessionid04' name='csessionid04'/>
                   <input type='hidden' id='sig04' name='sig04'/>
                   <input type='hidden' id='token04' name='token04'/>
                   <input type='hidden' id='scene04' name='scene04'/>
                </div>
...
data() {
  ...
  mounted(){
        ...
        Lib.M.aliBlock('#connectNewBlock',this,'csessionid04','sig04','token04','scene04')
  },
  //相关操作事件
  methods: {
    ...
    exist () {
      ...
      window.location.href = '../connectHasAccount/list.html?id=' + id;
    },
    onSelect(item){
                ...
                if(me.slideInfo.session == ''){
                    ...
                    me.interval = window.setInterval(function() {
                        if ((me.time--) <= 0) {
                                   ...
                                   Lib.M.aliBlock('#connectNewBlock',me,'csessionid04','sig04','token04','scene04')
                                    me.handleSlide('','','','')
                        }
                    }, 1000);
                Lib.M.loginAjax({
