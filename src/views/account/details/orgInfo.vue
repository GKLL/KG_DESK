              ...
              <el-form ref="form" label-width="150px">
                ...
                <el-form-item label="管理员身份证扫描件"   v-if = "personInfo.idcardBack != null || personInfo.idcardFront != null || personInfo.idcardPic != null">
                    <div class ='info_id_card'>
                      ...
                      <!-- <img :src = "imgUrl + personInfo.idcardFront"/> -->
                      <!-- <span>身份证正面扫描件已通过审核</span> -->
                                             <p class = 'info_id_card_p'>
                        <span>身份证正面扫描件</span>
                        <span>已通过审核</span>
                      </p>
...
<!--                     <div class ='info_id_card'>
  <img :src = "imgUrl + personInfo.idcardBack"/>
  <span>身份证背面扫描件已通过审核</span>
</div>
<div class ='info_id_card'>
  <img :src = "imgUrl + personInfo.idcardPic"/>
  <span>手持身份证扫描件已通过审核</span>
</div> -->
                </el-form-item>               
...
<!--                     <div class ='info_id_card'>
  <img :src = "imgUrl + personInfo.otherPic"/>
  <span>其他资质扫描件已通过审核</span>
</div> -->
