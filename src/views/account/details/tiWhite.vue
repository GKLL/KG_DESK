...
<!--         <span class = 'title fontbold font16'>我的氪金</span>
<span class = 'tv'>{{tiValue.balance}}<span>氪金</span></span> -->
        <span class = 'title fontbold font16'>我的氪金 <span style = "font-weight:100;" class = 'tv'>{{tiValue.balance}}<span>氪金</span></span></span>
        <div style = "margin-right:30px">
          <span class = 'title fontbold font16'>冻结氪金 <span class = 'tv' style = 'font-size:20px;font-weight:100;'><span style = "font-size:16px;">{{tiValue.frozenBalance != null ? tiValue.frozenBalance : 0}}</span><span>氪金</span></span></span>
  ...
  <el-button @click = "shift('./shift_in')" type="primary" size = 'mini' class = 'fr primay-btn2'>转入</el-button>    -->  
      ...
      <div>
        <div class = 'myTiValue myTiValue2'>
          <p>
            <span>今日获得氪金</span>
            <span>{{tiValue.todayIncome}}<em class = 'txbSpan'>氪金</em></span>
          </p>
          <p>
            <span>今日消耗</span>
            <span>{{tiValue.reduce}}<em class = 'txbSpan'>氪金</em></span>
          </p>
          <p>
            <span>昨日获得氪金</span>
            <span>{{tiValue.beforeIncome}}<em class = 'txbSpan'>氪金</em></span>
          </p>    
          <p>
            <span>累计获得氪金</span>
            <span>{{tiValue.income}}<em class = 'txbSpan'>氪金</em></span>
          </p>
        </div>
      </div>
 ...
 header-align = "center"
                  ...
                  <el-table-column
                    ...
                    <template slot-scope="scope">
                       <p> {{scope.row.amount}}氪金</p>
<!--                        <p> {{ scope.row.freezeAmount == 0 ? scope.row.amount : scope.row.freezeAmount }}氪金</p>
          ...
          <el-tab-pane label="奖励" name="1">
             ...
             <el-tab-pane label="进贡" name="2">
                ...
                <el-table-column
                        ...
                        label="氪金">
                        <template slot-scope="scope">
                           <p> {{ scope.row.freezeAmount == 0 || scope.row.freezeAmount == null ? scope.row.amount : scope.row.freezeAmount }}氪金</p>
                           <p class="freezeColor"> {{ scope.row.freezeAmount > 0?"冻结中":"" }}</p>
                        </template>
                  </el-table-column>
                </el-table>
...
export default {
  ...
  mounted(){
      ...
      //流水信息
      this.activeName = localStorage.getItem('txbactiveName')  == null ? '0' :  localStorage.getItem('txbactiveName');
      console.log('txbactiveName',localStorage.getItem('txbactiveName'))
  ...
  methods: {
    ...
    handleClick(tab, event) {
      // localStorage.setItem('txbactiveName',tab.index);
...
/* .tiValueContainer tbody .el-table_1_column_22 .cell,
.tiValueContainer tbody .el-table_1_column_26 .cell,
.tiValueContainer tbody .el-table_1_column_30 .cell,
.tiValueContainer tbody .el-table_1_column_34 .cell,
.tiValueContainer tbody .el-table_1_column_38 .cell{
   background:#1d87ff;
  border-radius: 50%;
  width:60px;
  height:60px;
